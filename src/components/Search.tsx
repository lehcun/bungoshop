  ...
  return (
    <div className="relative">
      <input
        ...
        type="text"
        className="flex-1 rounded-full border-1 border-solid border-gray-500 px-10 py-3 text-gray-500 focus:border-gray-600 focus:ring-2 focus:ring-blue-500 md:w-lg"
      />
